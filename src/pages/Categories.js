  ...
  return (
    <div className="container-cat">
      <div className="card-cat">
        <NavLink className="link" to={SHOP_ROUTE}>
          ...
          <div className="face face2">
            <div className="content-cat">
              <p>
                ...
                промышленной электронике, предназначенным для управления
                скоростью и частотой вращения электродвигателей. Он позволяет
                эффективно регулировать скорость механизмов и оборудования, что
                обеспечивает гибкость и оптимизацию процессов в различных
          ...
          <div className="face face2">
            <div className="content-cat">
              <p>
                ...
                надежное управление, что способствует повышению
                производительности и безопасности работы в широком спектре
                отраслей.
              </p>
              <NavLink className="link" to={SHOP_ROUTE}>
                Каталог
      ...
      <div className="card-cat">
        <NavLink className="link" to={SHOP_ROUTE}>
          ...
          <div className="face face2">
            <div className="content-cat">
              <p>
                ПЛК контроллеры широко используются в различных отраслях,
                включая промышленность, энергетику, автомобильный и
                производственный сектор. Они обеспечивают надежность, гибкость и
                эффективность управления автоматизированными системами, что
                позволяет повысить производительность и оптимизировать процессы
                работы.
              </p>
              <NavLink className="link" to={SHOP_ROUTE}>
                Каталог
          ...
          <div className="face face2">
            <div className="content-cat">
              <p>
                ...
                возможна автоматизация, оптимизация и улучшение
                производительности в различных областях.
              </p>
              <NavLink className="link" to={SHOP_ROUTE}>
                Каталог
              </NavLink>
          ...
          <div className="face face2">
            <div className="content-cat">
              <p>
                ...
                требуется точное измерение, отслеживание или управление
                позицией, скоростью или углом.
              </p>
              <NavLink className="link" to={SHOP_ROUTE}>
                Каталог
              </NavLink>
      ...
      <div className="card-cat">
        <NavLink className="link" to={SHOP_ROUTE}>
          ...
          <div className="face face2">
            <div className="content-cat">
              <p>
                Электромагнитные тормоза широко применяются в различных
                областях, включая текстильную промышленность, станочное
                оборудование, подъемные механизмы, транспортные системы и другие
                приложения, где требуется точное и надежное торможение и
                удержание механизма.
              </p>
              <NavLink className="link" to={SHOP_ROUTE}>
                Каталог
          ...
          <div className="face face2">
            <div className="content-cat">
              <p>
                ...
                соответствовать требованиям конкретного механизма или
                устройства. Изготавливаем пневмовалы, банановые валы
                индивидуально по вашим размерам
              </p>
              <NavLink className="link" to={SHOP_ROUTE}>
                Каталог
              </NavLink>
